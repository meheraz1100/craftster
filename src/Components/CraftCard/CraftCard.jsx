...
const CraftCard = ({crafts, setCrafts, craft }) => {
  const {
    _id,
    email,
    name,
          ...
          <div className="card-actions justify-end">
            <div className="join space-x-4 text-xl">
              ...
              <Link to={`/craftCardDetails/${_id}`}>
                <button className="tooltip join-item" data-tip="View Details"><FaEye></FaEye></button>
              </Link>

                <Link to={`updateCraftItem/${_id}`}>
                <button className="tooltip join-item" data-tip="Edit Item">
